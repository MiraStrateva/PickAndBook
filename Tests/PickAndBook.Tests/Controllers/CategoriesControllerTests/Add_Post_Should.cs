...
namespace PickAndBook.Tests.Controllers.CategoriesControllerTests
{
    ...
    public class Add_Post_Should
    {
        ...
        public void ReturnDefaultViewWithModel_WhenStateIsNotValid()
        {
            ...
            // Act & Assert
            controller.WithCallTo(c => c.Add(categoryNotValid, null))
                .ShouldRenderDefaultView()
                .WithModel(categoryNotValid);
        }

        [Test]
        public void RedirectToDetails_WhenStateIsValidWithoutUploadedImage()
        {
            // Arrange
            var dataMock = new Mock<IPickAndBookData>();
            ...
            // Act & Assert
            controller.WithCallTo(c => c.Add(category, null))
                .ShouldRedirectTo(c => c.Details(category.CategoryId));
        }

        [Test]
        public void RedirectToDetails_WhenStateIsValidWithUploadedImage()
        {
            // Arrange
            var dataMock = new Mock<IPickAndBookData>();
            var categoryRepositoryMock = new Mock<ICategoryRepository>();
            ...
            // Act & Assert
            controller.WithCallTo(c => c.Add(category, postedFileMock.Object))
                .ShouldRedirectTo(c => c.Details(category.CategoryId));
        }
